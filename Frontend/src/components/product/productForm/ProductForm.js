      ...
      <div className='add-product'>
         <Card cardClass={"card"}>
            ...
            <form onSubmit={saveProduct}>
                 ...
                 <input type="text" placeholder='Product Quantuty' name="quantity" 
                        value={product?.quantity} onChange={handleInputChange} />

                 <label>Product Description</label>
                 <ReactQuill theme="snow" value={description} onChange={setDescription} 
                             modules={ProductForm.modules} formats={ProductForm.modules} />;
